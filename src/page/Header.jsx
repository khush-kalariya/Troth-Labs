...
const Header = ({ toggleSidebar }) => {
  ...
  return (
    <div
      className={`bg-white px-4 py-4 lg:px-20 lg:py-5 flex items-center justify-between fixed w-full top-0 z-50 border-b border-gray-400 transition-transform duration-300 ${
